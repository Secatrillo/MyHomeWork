...
public class TripletTests {
    ...
    private Deque<String> tQueue = new MyTripleDequeue<String>();
    ...
    void removeTest(){
        ...
        assertTrue(tQueue.contains("n_3"));
        tQueue.remove("n_3");
        assertFalse(tQueue.contains("n_3"));
    ...
    void holeTest(){
        ...
        assertTrue(cntr[0] != null && cntr[cntr.length-1] != null);
        tQueue.remove("2");
    ...
    void removeContainerTest(){
        ...
        assertTrue(cntr!=null && cntr1 != null && cntr2 !=null);
